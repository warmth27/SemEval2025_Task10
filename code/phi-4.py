...
tokenizer = AutoTokenizer.from_pretrained("/media/qust521/92afc6a9-13fd-4458-8a46-4b008127de08/LLMs/phi-4", use_fast=False, trust_remote_code=True)
model = AutoModelForCausalLM.from_pretrained("/media/qust521/92afc6a9-13fd-4458-8a46-4b008127de08/LLMs/phi-4", 
...
args = TrainingArguments(
    output_dir="./output/phi-4_EN_epoch",
